...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private static volatile Executor sDefaultExecutor = android.os.AsyncTask.THREAD_POOL_EXECUTOR;
    ...
    /**
     * <p>Attempts to cancel execution of this task.
     */
